...
export let LN2: number;
export let LN10: number;
export let TAU: number;
export let LOG2E: number;
export let LOG10E: number;
export let EPSILON: any;
export let PHI: number;
...
export function evaluateExpression(e: any): any;
